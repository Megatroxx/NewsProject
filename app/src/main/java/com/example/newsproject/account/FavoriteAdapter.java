...
public class FavoriteAdapter extends ListAdapter<DatabaseNews, FavoriteAdapter.NewsViewHolder> {
    ...
    private final SelectedViewModel viewModel;

    public FavoriteAdapter(Context context, SelectedViewModel viewModel) {
    ...
    public void onBindViewHolder(@NonNull NewsViewHolder holder, int position) {
        ...
        if (currentNews != null) {
            ...
            String time = formatTime(currentNews.getPublishedAt());
            String rightTime = time.substring(0, time.length() - 3);
